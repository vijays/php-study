...
<div class="container">
<?php echo form_open('Admin/update_article', ['class'=>'form_horizontal']); ?>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <?php echo form_input(['name'=>'title', 'class'=>'form-control', 'placeholder'=>'Input Article Title', 'value'=>set_value('title', $article->title)]) ?>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <?php echo form_textarea  (['name'=>'body', 'class'=>'form-control', 'placeholder'=>'Input Article Body', 'value'=>set_value('body', $article->body)]) ?>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
